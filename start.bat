...
=======
REM Start all services explicitly in detached mode
docker-compose up -d zookeeper kafka kafka-ui mongodb mongo-express spark-master spark-worker postgres airflow-init airflow-webserver airflow-scheduler kafka-producer kafka-consumer dashboard
>>>>>>> 1a17f12 (Update)
